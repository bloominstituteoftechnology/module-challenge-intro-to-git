...
1. What is git? What is the difference between git and GitHub? Git is for cloning nad pushing changes, github holds your repositories
2. Why do we create a branch? to be able to make changes without affecting the main copy
3. What is the purpose of a pull request? to compare the main and forked repos
4. What is the command you can use to switch between branches? For example you are working on a feature branch and you want to switch back to main.  git switch <branch name>
5. Explain the difference between `git fetch`, `git merge` and `git pull` what does each command do? 
git fetch pulls all commits and changes from remote repo to local repo
merge combines branches
git pulls changess from specific branch into your repo
6. What is a merge conflict? How do you resolve a merge conflict? 
open and make necessary changes

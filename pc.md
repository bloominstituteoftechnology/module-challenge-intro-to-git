...
Git is a type of version control for code. It is a software for version control tracking that developers can use to organize and control projects. The main difference between git and Github is that git is a software and github is a service.
2. Why do we create a branch? 
We can use branches as a development tool to isolate blocks of code for development.
3. What is the purpose of a pull request? 
A pull request is a way to let others know that a change has been made to the code.
4. What is the command you can use to switch between branches? For example you are working on a feature branch and you want to switch back to main. 
To create a new branch, you would use "$ git checkout -b 'name of new branch'". To switch between an existing branch, you would use "& git checkout 'name of existing branch'"
5. Explain the difference between `git fetch`, `git merge` and `git pull` what does each command do? 
git fetch allows you to check if there are any new commits different than yours.
git merge allows for two different branches to merge.
git pull is when you know for certain that there is a difference in the code. It automatically performs git fetch and allows you to decide which second action to perform.
6. What is a merge conflict? How do you resolve a merge conflict? 
There are three ways to achieve this.
a. Accept the local version with - git checkout --ours<file name>
b. Accept the remote version - git checkout --theirs<file name>
c. Review changes individually
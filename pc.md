...
1. What is git? What is the difference between git and GitHub?
    Git is a free open-source tool that is used to manage source code and do version control for projects. GitHub is a cloud-based hosting service that holds and lets you manage Git repositories.
2. Why do we create a branch? 
    So that we can isolate the changes we are making to the branch as opposed to the original repo. This helps with stability of a larger project by making sure individual portions of the project run as intended before changing the original repo.
3. What is the purpose of a pull request? 
    A pull request is used to inform your collaborators about the changes you make to a project. It is basically an indication that changes have been made.
4. What is the command you can use to switch between branches? For example you are working on a feature branch and you want to switch back to main. 
    git checkout nameOfBranch
5. Explain the difference between `git fetch`, `git merge` and `git pull` what does each command do? 
    git fetch is a command that gets all the commits made to a remote repository but doesn't make the changes to your local git repository. git merge will take the fetched changes and change your local repository. git pull will do both of these steps in one go, essentially fetching and then immediately merging.
6. What is a merge conflict? How do you resolve a merge conflict? 
    A merge conflict is when there are different changes that have been made to the same line of code. you can use git status to help identify the conflict. You can fix it by directly editing the txt file with the code.
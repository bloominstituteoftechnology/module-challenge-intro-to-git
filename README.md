...
- [done] Create your own version of this repo using the fork button at the top right of the repository
- [done] Clone this repo by clicking the green Code button, then copy pasting the SSH URL: `git clone git@github.com:YOUR-GITHUB-USERNAME/Git-for-Web-Development-Project.git`
- [done] Create a branch: `git checkout -b 'FIRSTNAME-LASTNAME'`
- [done] Answer the questions in the `mac.md` or `pc.md` file, depending on which operating system you are using.

...
Git is an open source version control system, while GitHub is a cloud-based git hosting service.
2. Why do we create a branch? 
To isolate our own work from the main branch.
3. What is the purpose of a pull request? 
It updates the local repo.
4. What is the command you can use to switch between branches? For example you are working on a feature branch and you want to switch back to main. 
You would use git switch.
5. Explain the difference between `git fetch`, `git merge` and `git pull` what does each command do? 
Git fetch downloads objects or refs from another repo, Git merge joins histories together, and Git pull integrates with another repo or local branch.
6. What is a merge conflict? How do you resolve a merge conflict? 
When there are a pair of conflicting changes, you can decide not to merge or resolve what is conflicting.

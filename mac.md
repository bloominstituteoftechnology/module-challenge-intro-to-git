...
Git is an Open Source Distributed Version Control System. Code can be easily redistributed, modified, and stored. GitHub is a company that offers a cloud based git hosting service. 
2. Why do we create a branch? 
We want to create a branch so our work is independent from everyone else's work.
3. What is the purpose of a pull request? 
The pull request submits our work from our branch to compare it to the main code. We can see what we've edited and added.
